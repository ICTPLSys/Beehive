...
impl<'a, It1: RemIteratorTrait<'a>> DerefScopeTrait for RemZip1<'a, It1> {}
...
impl<'a, It1: RemIteratorTrait<'a>> AsyncZipTrait for RemZip1<'a, It1> {
    type Item = (&'a dyn DerefScopeTrait, It1::Item);
    async fn next_async(&mut self) -> Option<Self::Item> {
        ...
        match self
            .it1
            .next_async(unsafe { std::mem::transmute(scope) })
            .await
        {
            Some(item) => Some((
                unsafe { std::mem::transmute(self as &dyn DerefScopeTrait) },
...
impl<'a, It1: RemIteratorTrait<'a>, It2: RemIteratorTrait<'a>> DerefScopeTrait
    for RemZip2<'a, It1, It2>
{
}

impl<'a, It1: RemIteratorTrait<'a>, It2: RemIteratorTrait<'a>> AsyncZipTrait
    for RemZip2<'a, It1, It2>
{
    type Item = (&'a dyn DerefScopeTrait, It1::Item, It2::Item);
    async fn next_async(&mut self) -> Option<Self::Item> {
